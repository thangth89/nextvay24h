          ...
          <div style={{
            ...
            <div style={{ flex: "1 1 150px" }}>
              ...
              <ul style={{ listStyle: "none", padding: 0, fontSize: "14px" }}>
                <li><Link href="/gioi-thieu" style={footerLink}>Giới thiệu vay24.pro.vn</Link></li>
                <li><Link href="/dieu-khoan" style={footerLink}>Điều khoản sử dụng</Link></li>
                <li><Link href="/chinh-sach" style={footerLink}>Chính sách bảo mật</Link></li>
                <li><Link href="/lien-he" style={footerLink}>Liên hệ với chúng tôi</Link></li>
              </ul>
            </div>
            ...
            <div style={{ flex: "1 1 150px" }}>
              ...
              <ul style={{ listStyle: "none", padding: 0, fontSize: "14px" }}>
                <li><Link href="/vay-tien-nhanh" style={footerLink}>Vay tiền uy tín</Link></li>
                <li><Link href="/the-tin-dung" style={footerLink}>Mở thẻ tín dụng</Link></li>
                <li><Link href="/" style={footerLink}>Hướng dẫn cơ bản</Link></li>
                <li><Link href="/tin-tuc" style={footerLink}>Tổng hợp tin tức</Link></li>
              </ul>
            </div>
          </div>
...
// Xóa biến navLink không sử dụng
const footerLink = {
  color: "#ccc",
  textDecoration: "none",
  display: "block",
